...
class Alumno(Base):
    ...
    id_origen = Column(Integer, unique=True)
...
class AppViewer(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    id_notificaciones = Column(Integer, ForeignKey("notificaciones.id", ondelete="CASCADE"))
    id_beneficios = Column(Integer, ForeignKey("beneficios.id", ondelete="CASCADE"))
